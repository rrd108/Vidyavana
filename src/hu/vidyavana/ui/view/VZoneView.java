...
/**
 * A copy of ZoneView to allow Zone inner class to extend a fixed replacement of the buggy AsyncBoxView.
 */
public class VZoneView extends BoxView
{
	 ...
	 */
	public VZoneView(Element elem, int axis)
	{
		super(elem, axis);
	...
	protected View createZone(int p0, int p1)
	{
		...
		catch(BadLocationException ble)
		{
			...
			throw new Error(ble.getMessage());
		}
		return zone;
	}
	 ...
	 */
	class Zone extends VAsyncBoxView
	{
		...
		{
			super(elem, VZoneView.this.getAxis());
			this.start = start;
			this.end = end;
		}
		...
		{
			return VZoneView.this.getAttributes();
		}
